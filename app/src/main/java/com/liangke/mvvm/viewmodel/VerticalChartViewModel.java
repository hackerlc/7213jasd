...
import com.liangke.mvvm.rxbing.VerticalChartBing;
...
public class VerticalChartViewModel extends BaseViewModel {

    private final String TAG = VerticalChartViewModel.class.getSimpleName();

    private VerticalChartFragment fragment;
    ...
    public VerticalChartViewModel(VerticalChartFragment fragment,FragmentVerticalchartBinding binding) {
        super(fragment.getActivity());
        this.fragment = fragment;
        this.binding = binding;
        historyModel = new HistoryModel(mContext,observer);
        VerticalChartBing bing = new VerticalChartBing(fragment.getActivity(),this,binding);
...
//        SubscribeMessage.sendSubscribeMessage(commdity);
    ...
    public void change(){
        ((SingleMarketActivity)fragment.getActivity()).getViewModel().change();
    }
