...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public GridDividerItemDecoration(Context context, int dividerHight, int dividerColor) {
        this(context);
     ...
     */
    public GridDividerItemDecoration(Context context, int dividerHight, Drawable dividerDrawable) {
        this(context);
        mDividerHight = dividerHight;
